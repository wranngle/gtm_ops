 ...
 *
 * Usage:
 *   bun scripts/build_presales_db.js
 *   bun scripts/build_presales_db.js --out /tmp/test.db
 *
 * Exit codes:
...
function printHelp() {
  process.stdout.write(
    `build_presales_db.js — rebuild config/presales.db from seed SQL\n\n`
      + `Usage:\n`
      + `  bun scripts/build_presales_db.js [--out <path>]\n\n`
      + `Options:\n`
