...
/*
 * Locks the BillingSettings "Change plan" tier list inside apps/ops-console/console/pages-2.jsx
 ...
 *
 * pages-2.jsx is loaded in the browser via <script type="text/babel"> so it has
...
const PAGES_2_PATH = path.join(REPO_ROOT, 'apps', 'ops-console', 'console', 'pages-2.jsx');
...
function extractConsoleTiers(): ConsoleTier[] {
  ...
  if (!arrayMatch) throw new Error('GTM_OPS_TIERS literal not found in pages-2.jsx');
