 ...
 * @param {Partial<import('./schemas/business_profile.schema.js').BusinessProfile>} profile
 * @returns {Promise<Partial<import('./schemas/business_profile.schema.js').BusinessProfile>>}
 */
