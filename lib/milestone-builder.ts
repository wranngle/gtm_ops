...
import { formatCurrency } from './project-identity.js';
 ...
 */
export function buildPhase3Scale(auditData, _options = {}) {
 ...
 */
export function buildProductPhase2(intake, productPricing, _options = {}) {
 ...
 */
function buildProductPhase3(intake, productPricing, _options = {}) {
  return {
    phase_id: uuidv4(),
    phase_number: 3,
    phase_name: 'Expand',
