      ...
      <div className="app" data-collapsed={collapsed} data-route={route}>
        ...
        <div className="main">
          ...
          <main ref={scrollRef} className="scroll" key={route} aria-labelledby="console-page-title">
            ...
            {route === 'funnel' && <FunnelPage setRoute={setConsoleRoute}/>}
            ...
            {route === 'verticals' && <VerticalsPage setRoute={setConsoleRoute}/>}
            {route === 'replay' && <ReplayPage setRoute={setConsoleRoute}/>}
